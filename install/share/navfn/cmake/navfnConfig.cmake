...
if("FALSE" STREQUAL "TRUE")
  set(navfn_SOURCE_PREFIX /home/nvidia/WashBot/src/navigation/navfn)
  set(navfn_DEVEL_PREFIX /home/nvidia/WashBot/devel)
  set(navfn_INSTALL_PREFIX "")
  set(navfn_PREFIX ${navfn_DEVEL_PREFIX})
else()
  set(navfn_SOURCE_PREFIX "")
  set(navfn_DEVEL_PREFIX "")
  set(navfn_INSTALL_PREFIX /home/nvidia/WashBot/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'navfn' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/WashBot/install/${idir}'.  ${_report}")
    endif()
