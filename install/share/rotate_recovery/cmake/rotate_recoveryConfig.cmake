...
if("FALSE" STREQUAL "TRUE")
  set(rotate_recovery_SOURCE_PREFIX /home/nvidia/WashBot/src/navigation/rotate_recovery)
  set(rotate_recovery_DEVEL_PREFIX /home/nvidia/WashBot/devel)
  ...
  set(rotate_recovery_INSTALL_PREFIX /home/nvidia/WashBot/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rotate_recovery' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/WashBot/install/${idir}'.  ${_report}")
    endif()
