...
if("FALSE" STREQUAL "TRUE")
  set(clear_costmap_recovery_SOURCE_PREFIX /home/nvidia/WashBot/src/navigation/clear_costmap_recovery)
  set(clear_costmap_recovery_DEVEL_PREFIX /home/nvidia/WashBot/devel)
  ...
  set(clear_costmap_recovery_INSTALL_PREFIX /home/nvidia/WashBot/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'clear_costmap_recovery' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/WashBot/install/${idir}'.  ${_report}")
    endif()
