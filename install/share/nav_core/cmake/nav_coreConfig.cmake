...
if("FALSE" STREQUAL "TRUE")
  set(nav_core_SOURCE_PREFIX /home/nvidia/WashBot/src/navigation/nav_core)
  set(nav_core_DEVEL_PREFIX /home/nvidia/WashBot/devel)
  set(nav_core_INSTALL_PREFIX "")
  set(nav_core_PREFIX ${nav_core_DEVEL_PREFIX})
else()
  set(nav_core_SOURCE_PREFIX "")
  set(nav_core_DEVEL_PREFIX "")
  set(nav_core_INSTALL_PREFIX /home/nvidia/WashBot/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'nav_core' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/WashBot/install/${idir}'.  ${_report}")
    endif()
