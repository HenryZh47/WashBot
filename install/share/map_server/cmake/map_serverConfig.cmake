...
if("FALSE" STREQUAL "TRUE")
  set(map_server_SOURCE_PREFIX /home/nvidia/WashBot/src/navigation/map_server)
  set(map_server_DEVEL_PREFIX /home/nvidia/WashBot/devel)
  ...
  set(map_server_INSTALL_PREFIX /home/nvidia/WashBot/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'map_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/WashBot/install/${idir}'.  ${_report}")
    endif()
